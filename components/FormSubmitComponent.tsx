...
function FormSubmitComponent({
  ...
  return (
    <div className="flex justify-center flex-grow w-full h-full items-center p-8 mb-24">
      <div
        key={renderKey}
        className="max-w-[820px] flex flex-col gap-4  bg-background w-full p-8 border shadow-xl rounded"
      >
        {content.map((element) => {
